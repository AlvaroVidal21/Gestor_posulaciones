...
La columna `estado` en BD solo guarda `Postulado` o `Rechazado`. Cuando una postulación lleva más de 15 días sin actualizarse, el sistema **muestra** `Vencido` pero **no escribe** ese valor en la tabla.
